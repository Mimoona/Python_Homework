...
If you run the code as is, without modifications, it should run without errors; however, the report information will be wrong. Your job is to correct the 'fix me's.
"""

print(f"This is a report about the \'Introduction to Magic\' course.")
...
# math operations, define the variable `avg_grade` as the average grade of the
# students.
